import { DatePicker, Rate, Select, Table } from "antd";
...
export default function TeacherClassFeedbackAd() {
  const navigate = useNavigate();

  const handleClickEdit = (teacherID) => {
    console.log("bam edit");
    navigate(
      `/dash-board-admin/teacher-management/class-feedback/class-report-detail/${teacherID}`
    );
  };
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, record) => {
        console.log(record);
        return <Rate disabled defaultValue={record.feedback} />;
      },
    },
    {
      title: "Date",
