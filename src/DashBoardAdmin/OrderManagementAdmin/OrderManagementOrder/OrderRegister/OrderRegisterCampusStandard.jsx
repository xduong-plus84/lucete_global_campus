...
export default function OrderRegisterCampusStandard() {
  let { campusID } = useParams();
  ...
  return (
    <div id="OrderRegisterCampusStandard">
      <p>
        OrderRegisterCampusStandard <br /> campusID: {campusID}
      </p>
      <div className="flex justify-center flex-wrap pt-4 pb-8 mb-4 border-b-2">
        <ul>
          ...
          <li className="flex my-3">
            <p className="font-bold mr-1 ml-4 w-32">*Product</p>
            <Select
              size={"small"}
