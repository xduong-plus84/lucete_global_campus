...
export default function RoleManagementRegister() {
  const navigate = useNavigate();
  let { someThingID } = useParams();
  console.log("someThingID: ", someThingID);

  let [roleRegister, setRoleRegister] = useState("Campus Manager");
    ...
    switch (roleRegister) {
        ...
        return (
          <ul>
            <li className="flex my-2">
              <p className="w-40">Student Register</p>
            ...
            <li className="flex my-2">
              <p className="w-40">Teacher Register</p>
              <Radio.Group onChange={onChange} defaultValue={1}>
                <Radio value={1}>Y</Radio>
                <Radio value={0}>N</Radio>
              </Radio.Group>
            ...
            <li className="flex my-2">
              <p className="w-40">Class Arrangement</p>
              <Radio.Group onChange={onChange} defaultValue={1}>
                <Radio value={1}>Y</Radio>
                <Radio value={0}>N</Radio>
              </Radio.Group>
            ...
            <li className="flex my-2">
              <p className="w-40">Study Planner</p>
              <Radio.Group onChange={onChange} defaultValue={1}>
                <Radio value={1}>Y</Radio>
                <Radio value={0}>N</Radio>
              </Radio.Group>
      ...
      case "Online Teacher": {
        return (
          <ul>
            <li className="flex my-2">
              <p className="w-40">Arrange classroom</p>
              <Radio.Group onChange={onChange} defaultValue={1}>
                <Radio value={1}>Y</Radio>
                <Radio value={0}>N</Radio>
              </Radio.Group>
            ...
            <li className="flex my-2">
              <p className="w-40">Giving points</p>
              <Radio.Group onChange={onChange} defaultValue={1}>
                <Radio value={1}>Y</Radio>
                <Radio value={0}>N</Radio>
              </Radio.Group>
            ...
            <li className="flex my-2">
              <p className="w-40">Class report</p>
              <Radio.Group onChange={onChange} defaultValue={1}>
                <Radio value={1}>Y</Radio>
                <Radio value={0}>N</Radio>
              </Radio.Group>
            ...
            <li className="flex my-2">
              <p className="w-40">Tranning mode</p>
              <Radio.Group onChange={onChange} defaultValue={1}>
                <Radio value={1}>Y</Radio>
                <Radio value={0}>N</Radio>
              </Radio.Group>
      ...
      <div className="registerRoleTwo">
        <ul>
          ...
          <li className="flex my-2">
            ...
            />
            {/* <button className="w-20 btn ml-2 px-3 font-semibold rounded bg-gray-800 text-gray-100 hover:bg-green-500 duration-500">
            Reset
          </button> */}
          </li>
          <li className="flex my-2">
