...
import StudentTimeTable from "../../../../DashBoardStudent/StudentManagement/StudentTimeTable/StudentTimeTable";

export default function AdminStudyPlannerStudent() {
  ...
  const renderMatchedStudyPlanner = () => {
    return (
  ...
  return (
    <div id="AdminStudyPlannerStudent">
      {renderInfoStudent()}
      {renderMatchedStudyPlanner()}
    </div>
  );
}
