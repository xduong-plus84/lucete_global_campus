...
import OnlineClassRegisterTimeTable from "./OnlineClassRegisterTimeTable";
...
export default function OnlineClassRegister() {
        ...
        <li className="flex my-2">
          ...
          <div>
            {dataMatchedStudent.map((item, index) => (
              <p key={index} className="px-4 py-1 mr-1 mb-1 border rounded-md">
                {item}
              </p>
            ))}
          </div>
