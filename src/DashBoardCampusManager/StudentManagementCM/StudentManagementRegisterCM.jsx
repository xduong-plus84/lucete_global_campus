...
import StudentManagementRegisterTableCM from "./StudentManagementRegisterTableCM";
...
export default function StudentManagementRegisterCM() {
  ...
  return (
    <div id="StudentManagementRegisterCM">
      <p>somethingID:{somethingID}</p>
      <p>StudentManagementRegisterCM</p>
      ...
      <div className="w-1/2 mx-auto">
        <p className="my-2 font-bold">Time Table</p>
        <StudentManagementRegisterTableCM />
      </div>
