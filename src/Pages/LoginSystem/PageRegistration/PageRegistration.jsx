...
export default function PageRegistration() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (dataRegister) => {
      alert(`Submit form dataRegister: ${dataRegister}`);
          ...
          <div className="flex flex-col items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
            ...
            <div className="w-full">
              ...
              <form onSubmit={formik.handleSubmit}>
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      name="emailAddress"
                      id="emailAddress"
                      placeholder="johnsow@example.com"
                      className="w-full px-4 py-3 rounded-md border border-gray-300 bg-gray-50 text-gray-800"
                    />
                  </div>
                  <div>
                ...
                <button className="block w-1/2 mx-auto mt-6 p-3 text-center rounded-md text-gray-50 bg-green-600 hover:opacity-50 duration-300">
                  Create an account
                </button>
              </form>
            </div>
            <div className="w-full">
              ...
              <Link to={"/login"}>
                <button className="block w-1/2 mx-auto mt-2 p-3 text-center rounded-md text-gray-50 bg-gray-600 hover:opacity-50 duration-300">
                  Sign in
                </button>
              </Link>
            </div>
