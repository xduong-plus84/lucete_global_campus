...
// demo loacalstorage
const parent1 = { ma: "ph1", name: "Father 1", role: "parents" };
const parent2 = { ma: "ph2", name: "Father 2", role: "parents" };

const student1 = { ma: "hs1", name: "Student 1", role: "student" };
const student2 = { ma: "hs2", name: "Student 2", role: "student" };

const teacher1 = { ma: "gv1", name: "Teacher 1", role: "teacher" };
const teacher2 = { ma: "gv2", name: "Teacher 2", role: "teacher" };

const admin1 = { ma: "ad1", name: "Admin 1", role: "admin" };
const admin2 = { ma: "ad2", name: "Admin 2", role: "admin" };

const campusManger1 = {
  ma: "cm1",
  name: "Campus Manager 1",
  role: "campusManager",
};
const campusManager2 = {
  ma: "cm2",
  name: "Campus Manager 2",
  role: "campusManager",
};
// demo loacalstorage
...
export default function PageLogin() {
    ...
    onSubmit: (thongTinDangNhap) => {
      ...
      if (password != "") {
        switch (username) {
          case "student": {
            onSuccess();
            serviceLocalStorageUser.user.set(student1);
            break;
          }
          case "teacher": {
            onSuccess();
            serviceLocalStorageUser.user.set(teacher1);
            break;
          }
          case "parent": {
            onSuccess();
            serviceLocalStorageUser.user.set(parent1);
            break;
          }
          case "admin": {
            onSuccessAdmin();
            serviceLocalStorageUser.user.set(admin1);
            break;
          }
          case "campus manager": {
            onSuccessCampusManager();
            serviceLocalStorageUser.user.set(campusManger1);
            break;
          }
          default: {
            onFail();
  ...
  let onSuccessAdmin = () => {
    message.success("Success");
    setTimeout(() => {
      navigate("/dash-board-admin/role-management");
    }, 1000);
  };

  let onSuccessCampusManager = () => {
    message.success("Success");
    setTimeout(() => {
      navigate("/campus-manager/role-management");
    }, 1000);
  };
